...
const Disclaimer = () => (
  <Container>
    ...
    <p className="text-xl mb-5">Last Updated December 01, 2021</p>
    <h3 className="mb-5 text-2xl font-bold">Website Disclaimer</h3>
    ...
    <h3 className="mb-5 text-2xl font-bold">Professional Disclaimer</h3>

    <p className="text-xl mb-5">
      The Site cannot and does not contain life coaching advice. The life
      coaching information is provided for general informational and educational
      ...
      provide any kind of life coaching advice. THE USE OR RELIANCE OF ANY
      INFORMATION CONTAINED ON THE SITE IS SOLELY AT YOUR OWN RISK.
    </p>

    <h3 className="mb-5 text-2xl font-bold">Testimonial Disclaimer</h3>
    <p className="text-xl mb-5">
